<header class="site-header" data-header>
    <div class="site-container header-inner">
        ...
        <div class="header-actions">
            ...
            <a class="button button-small button-accent header-contact" href="https://wa.me/5551985450905" target="_blank" rel="noopener noreferrer">
                Entrar em contato
    ...
    <div class="mobile-menu" id="mobile-menu" data-mobile-menu>
        ...
        <a class="button button-accent" href="https://wa.me/5551985450905" target="_blank" rel="noopener noreferrer">
            Entrar em contato
            <x-site.icon name="arrow-up-right" />
        </a>
